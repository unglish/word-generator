...
export type BySyllablePosition<T> = {
    onset: T;
    nucleus: T;
    coda: T;
};
 ...
 */
export declare function validateConfig(config: LanguageConfig): void;
/**
 ...
 */
export declare function computeSonorityLevels(config: LanguageConfig): Map<Phoneme, number>;
