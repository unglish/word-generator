...
import {
  ...
  PHONEME_TO_SYLLABLE_WEIGHTS_LEXICON,
...
export const englishConfig: LanguageConfig = {
  ...
  phonemeLengthWeights: {
    text: PHONEME_LENGTH_WEIGHTS_TEXT,
    lexicon: PHONEME_LENGTH_WEIGHTS_LEXICON,
  },

  phonemeToSyllableWeights: {
    text: PHONEME_TO_SYLLABLE_WEIGHTS_TEXT,
  ...
  orthographyExceptions: [
    { name: "be", phonemes: ["b", "i:"], replacement: "be" },
    { name: "he", phonemes: ["h", "i:"], replacement: "he" },
    { name: "me", phonemes: ["m", "i:"], replacement: "me" },
    { name: "we", phonemes: ["w", "i:"], replacement: "we" },
    { name: "to", phonemes: ["t", "u"], replacement: "to" },
    { name: "do", phonemes: ["d", "u"], replacement: "do" },
    { name: "you", phonemes: ["j", "u"], replacement: "you" },
    { name: "any", phonemes: ["ɛ", "n", "i:"], replacement: "any", hyphenated: "a&shy;ny" },
    { name: "people", phonemes: ["p", "i:", "p", "ə", "l"], replacement: "people", hyphenated: "peo&shy;ple" },
    { name: "would", phonemes: ["w", "ʊ", "d"], replacement: "would" },
    { name: "could", phonemes: ["k", "ʊ", "d"], replacement: "could" },
    { name: "who", phonemes: ["h", "u"], replacement: "who" },
    { name: "when", phonemes: ["w", "ɛ", "n"], replacement: "when" },
    { name: "which", phonemes: ["w", "ɪ", "tʃ"], replacement: "which" },
    { name: "what", phonemes: ["w", "ɑ", "t"], replacement: "what" },
  ],
  ...
  morphology: {
    ...
    templateWeights: {
      ...
      lexicon: { bare: 30, suffixed: 48, prefixed: 14, both: 8 },
    },
  },
