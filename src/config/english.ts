...
export const englishConfig: LanguageConfig = {
  ...
  morphology: {
    ...
    prefixes: [
      ...
      { type: 'prefix', written: 'in', phonemes: ["ɪ", "n"], syllableCount: 1, stressEffect: 'secondary', frequency: 50, allomorphs: [{ condition: 'before-bilabial', phonemes: ["ɪ", "m"], syllableCount: 1, written: "im" }] },
    ] satisfies Affix[],
    suffixes: [
      ...
      { type: 'suffix', written: 'est', phonemes: ["ɪ", "s", "t"], syllableCount: 1, stressEffect: 'none', frequency: 40, boundaryRules: { dropSilentE: true, doubleConsonant: true } },
      { type: 'suffix', written: 'ment', phonemes: ["m", "ə", "n", "t"], syllableCount: 1, stressEffect: 'none', frequency: 50 },
      { type: 'suffix', written: 'able', phonemes: ["ə", "b", "ə", "l"], syllableCount: 2, stressEffect: 'none', frequency: 40, boundaryRules: { dropSilentE: true, doubleConsonant: true, yToI: true } },
      { type: 'suffix', written: 'ful', phonemes: ["f", "ə", "l"], syllableCount: 1, stressEffect: 'none', frequency: 40, boundaryRules: { yToI: true } },
      ...
      { type: 'suffix', written: 'al', phonemes: ["ə", "l"], syllableCount: 1, stressEffect: 'attract-preceding', frequency: 30, boundaryRules: { dropSilentE: true } },
