...
export const englishConfig: LanguageConfig = {
  ...
  morphology: {
    ...
    suffixes: [
      ...
      { type: 'suffix', written: 'able', phonemes: ["ə", "b", "ə", "l"], syllables: [{ onset: [], nucleus: ["ə"], coda: [] }, { onset: ["b"], nucleus: ["ə"], coda: ["l"] }], syllableCount: 2, stressEffect: 'none', frequency: 23, boundaryTransforms: BT_ALL },
