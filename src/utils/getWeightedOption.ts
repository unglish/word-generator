 ...
 */
export const getWeightedOption = function (options: (number | { sound: string; type: string; sonority: number; complexity: number; nucleus: number; onset?: undefined; coda?: undefined; } | { sound: string; type: string; sonority: number; complexity: number; onset: number; coda: number; nucleus?: undefined; } | undefined)[][] | (string | number)[][]) {
  let choices: any[] = [];
